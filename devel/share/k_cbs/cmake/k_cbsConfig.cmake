...
if(NOT "/home/rancho/1hmy/k_cbs_swarmrviz/src/src/src/src/k-cbs/include " STREQUAL " ")
  set(k_cbs_INCLUDE_DIRS "")
  set(_include_dirs "/home/rancho/1hmy/k_cbs_swarmrviz/src/src/src/src/k-cbs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'k_cbs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rancho/1hmy/k_cbs_swarmrviz/src/src/src/src/k-cbs/${idir}'.  ${_report}")
    endif()
